	...
	return (
		...
		>
			<Flex justify={'space-between'} align={'center'} h={'full'} px={4}>
				<Text>
					© {format(new Date(), 'yyyy')} {siteConfig.siteName}. {t('footer', { ns: 'layout' })}
				</Text>
				<Flex gap={3} mr={2}>
					...
					<a href="https://www.instagram.com/pinnaclescienceilmiymarkaz?igsh=eWtjY2V5Ymx1Z29m&utm_source=qr" target="_blank" rel="noopener noreferrer">
						<IconButton icon={<FaInstagram />} colorScheme={'gray'} variant={'outline'} aria-label={'instagram'} />
					</a>
					<a href="https://youtube.com/@pinnaclesciencetadqiqotmarkaz?si=Go5Ovdt89cbOKFoF" target="_blank" rel="noopener noreferrer">
